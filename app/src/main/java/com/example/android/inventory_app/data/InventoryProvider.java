...
import com.example.android.inventory_app.data.EntryDbHelper;
...
public class InventoryProvider extends ContentProvider {
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(InventoryContract.InventoryTable.COLUMN_PRODUCT_NAME);
        if (name == null) {
            throw new IllegalArgumentException("Item requires a name");
        }

        Integer price = values.getAsInteger(InventoryContract.InventoryTable.COLUMN_PRODUCT_PRICE);
        ...
        String supplier_name = values.getAsString(InventoryContract.InventoryTable.COLUMN_SUPPLIER_NAME);
        if (supplier_name == null) {
            throw new IllegalArgumentException("Item requires valid supplier name");
        }

        String supplier_number = values.getAsString(InventoryContract.InventoryTable.COLUMN_SUPPLIER_PHONE_NUMBER);
        if (supplier_number == null) {
            throw new IllegalArgumentException("Item requires valid supplier number");
        }
    ...
    private int updateItem(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link InventoryTable#COLUMN_PRODUCT_NAME} key is present,
        // check that the name value is not null.
        if (values.containsKey(InventoryContract.InventoryTable.COLUMN_PRODUCT_NAME)) {
            String name = values.getAsString(InventoryContract.InventoryTable.COLUMN_PRODUCT_NAME);
            if (name == null) {
                throw new IllegalArgumentException("Item requires a name");
            }
        ...
        // If the {@link InventoryTable#COLUMN_PRODUCT_PRICE} key is present,
        // check that the price value is not null or less than 0.
        if (values.containsKey(InventoryContract.InventoryTable.COLUMN_PRODUCT_PRICE)) {
            Integer price = values.getAsInteger(InventoryContract.InventoryTable.COLUMN_PRODUCT_PRICE);
            if (price == null || price < 0) {
        ...
        // If the {@link InventoryTable#COLUMN_SUPPLIER_NAME} key is present,
        // check that the name value is not null.
        if (values.containsKey(InventoryContract.InventoryTable.COLUMN_SUPPLIER_NAME)) {
            String supplier_name = values.getAsString(InventoryContract.InventoryTable.COLUMN_SUPPLIER_NAME);
            if (supplier_name == null) {
        ...
        // If the {@link InventoryTable#COLUMN_SUPPLIER_PHONE_NUMBER} key is present,
        // check that the name value is not null.
        if (values.containsKey(InventoryContract.InventoryTable.COLUMN_SUPPLIER_PHONE_NUMBER)) {
            String supplier_number = values.getAsString(InventoryContract.InventoryTable.COLUMN_SUPPLIER_PHONE_NUMBER);
            if (supplier_number == null) {
                throw new IllegalArgumentException("Item requires a supplier number");
            }
        }
        ...
        int rowsUpdated = database.update(InventoryContract.InventoryTable.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case ITEMS:
                ...
                rowsDeleted = database.delete(InventoryContract.InventoryTable.TABLE_NAME, selection, selectionArgs);
                break;
            case ITEM_ID:
